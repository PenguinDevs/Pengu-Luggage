...
if (...) then
    ...
    return function(finder, startNode, endNode, clearance, toClear)
        ...
        while (#openList > 0) do
            ...
            breadth_first_search(finder, openList, node, endNode, clearance,
                                 toClear)
        end
